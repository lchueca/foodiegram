...
public interface ComentarioService {
    ...
    ComentarioResource editComentario(Integer comID,Integer userID, String text) throws IllegalArgumentException, NoPermissionException;

    //Devuelve un ComentarioResource con el comentario elimina (segun el comID), si el comentario no existe retorna null;
    ComentarioResource deleteComentario(Integer comID,Integer userID) throws NoPermissionException;
